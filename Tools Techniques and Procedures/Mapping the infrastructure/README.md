...
Nmap scripts
------------
Nmap from version 7.41 integrate some probes to find and recognize multiple WebUIs among: Apache Ambari, Apache Oozie, Apache Ranger, Cloudera HUE, Cloudera Manager, Hadoop MapReduce v2, Hadoop YARN. **No NSE specific script specification is needed for these, as they are bundled in the [**nselib/data/http-fingerprints.lua**](https://github.com/nmap/nmap/blob/master/nselib/data/http-fingerprints.lua) script.  
